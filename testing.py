...
model = wave_u_net(num_initial_filters = 24, num_layers = 12, kernel_size = 15, input_size = s_size, output_type = "single", attention = "Polarized", attention_res = True, dropout = "Last", dropout_rate = 0.2)
