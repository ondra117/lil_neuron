...
model = wave_u_net(num_initial_filters = 24, num_layers = 12, kernel_size = 15, input_size = s_size, output_type = "single", attention = "Polarized", attention_res = True, dropout = "False", dropout_rate = 0.2)
...
wavfile.write("t.wav", 44000, (sound * 32767 / 0.7).astype(np.int16))
print("done")