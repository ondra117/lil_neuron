...
model = wave_u_net(num_initial_filters = 24, num_layers = 12, kernel_size = 15, input_size = s_size, output_type = "single", attention = "Last", attention_res = False, dropout = "False", dropout_rate = 0.2)
