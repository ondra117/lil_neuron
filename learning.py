...
opt = keras.optimizers.Adam(learning_rate=0.000_01) #0.000_1
...
# 90
dataset = Dataset(list(range(90)) * 2, s_size=s_size, steps=steps, batch_size=batch_size, noise_ratio=noise_ratio, orig=True)
